...
# Hyperparameter
# C:      (Wirkt dem Overfitting entgegen)
#     Low -> smooth decision boundary
#     High -> Genauigkeit wichtiger
# Gamma: (wie wichtig ist einzelner Datenpunkt)
#     Low -> higher influence
#     High -> lower influence
C = 0.5 # Default = 1
gamma = 1 / x.shape[1] # Default = 1 / Anzahl der Datenpunkte -> = 1 / x.shape[1]
