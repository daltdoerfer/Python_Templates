...
x_train = x[indizes[:-train_size]] # Nimmt alle  Werte die den vertauschten Indizes hinterlegt sind. Jedoch nur die ersten 100 der 150 Werte, da [:-20]
y_train = y[indizes[:-train_size]]
print("Train X")
print(x_train)
print("Train Y")
print(y_train)
...
x_test = x[indizes[-train_size:]] # Nimmt alle  Werte die den vertauschten Indizes hinterlegt sind. Jedoch nur die ersten 20 der 150 Werte, da [:-20]
y_test = y[indizes[-train_size:]]
print("Test X")
print(x_test)
print("Test Y")
print(y_test)
